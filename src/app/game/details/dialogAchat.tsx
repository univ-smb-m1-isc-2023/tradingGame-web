...
export function DialogAchat() {
  ...
  return (
    <>
      <Button className="px-4 py-4 mr-2 bg-green-500 text-white rounded-md focus:outline-none" onClick={handleOpen} variant="gradient"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        Achat
      </Button>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-80"> {/* Ajoutez la classe bg-white pour définir un arrière-plan blanc */}
    <div className="border border-black p-4 rounded-lg bg-white">
      <DialogHeader  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>Achat  d'ordre de trading</DialogHeader>
